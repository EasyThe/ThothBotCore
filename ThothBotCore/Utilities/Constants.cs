...
namespace ThothBotCore.Utilities
{
    public class Constants
    {
        ...
        public static readonly string JoinedMessage = ":wave:**Hi. Thanks for adding me!**\n" +
                ...
                $":small_orange_diamond:Please make sure I have **View Channel**, **Send Messages**, **Read Messages**, **Embed Links** and **Use External Emojis** in the channels you would like me to respond to your commands.";
